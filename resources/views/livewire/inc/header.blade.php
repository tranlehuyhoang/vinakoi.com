...
<header
                                    ...
                                    <div class="ast-site-title-wrap">
                                        <h1 class="site-title" itemprop="name">
                                            <a href="/" rel="home" itemprop="url">
                                                VinaKoi Pet Food - Thức ăn thú cưng cao cấp đến từ Nhật Bản
                                            </a>
                                        </h1>
    ...
    <div class="jet-ajax-search__fields-holder">
        <div class="jet-ajax-search__field-wrapper">
            ...
            <input id="search-input-377de8a" class="jet-ajax-search__field" type="search" name="search" placeholder="Nhập sản phẩm cần tìm ..."
                   autocomplete="off" />
        </div>
    </div>

    <button id="btn-searchs" class="" style="background-color: #0066B3; padding: 5px 15px 12px 15px; color: #fff !important;" type="submit" aria-label="Search submit">
                            ...
                            <aside
                                ...
                                <section id="elementor-library-4" class="widget widget_elementor-library">
                                    <div data-elementor-type="section" data-elementor-id="708"
                                        class="elementor elementor-708" data-elementor-post-type="elementor_library">
                                        <section
                                ...
                                <button type="button"
                                    ...
                                    <span class="mobile-menu-toggle-icon">
                                        <span class="ahfb-svg-iconset ast-inline-flex svg-baseline"><svg
                                                class='ast-mobile-svg ast-menu2-svg' fill='currentColor' version='1.1'
                                                                        ...
                                                                        <a id="elementor-menu-cart__toggle_button"
                                                                            ...
                                                                            <span class="elementor-button-text"><span
                                                                                    class="woocommerce-Price-amount amount"><bdi>0<span
                                                                                            class="woocommerce-Price-currencySymbol">&#8363;</span></bdi></span></span>
                                                                            <span class="elementor-button-icon">
                                                                                <span class="elementor-button-icon-qty"
                                                                                    data-counter="0">0</span>
                                                                                <i class="eicon-basket-solid"></i>
                                                                                <span
                                                                                    class="elementor-screen-only">Cart</span>
                                ...
                                <div class="ast-builder-layout-element ast-flex site-header-focus-item"
                                    ...
                                    <div class="site-branding ast-site-identity"
                                        ...
                                        <div class="ast-site-title-wrap">
                                            <h1 class="site-title" itemprop="name">
                                                <a href="/" rel="home" itemprop="url">
                                                    VinaKoi Pet Food - Thức ăn thú cưng cao cấp đến từ Nhật
                                                    Bản
                                                </a>
                                            </h1>
                                                                    ...
                                                                    <a href="/blog/chu-de-ca-koi/"
                                                                        class="menu-link"><span
                                                                            class="ast-icon icon-arrow"><svg
                                                                                ...
                                                                                <path
                                                                                    d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                                                            </svg></span><span class="menu-text">Chủ đề
                                                                            cá
                                                                            Koi</span></a>
                                                                </li>
                                                                <li
